...
public class TestEventState {
    ...
    void testConstructors() {
        assertEquals(eventState.getAllEvents(), List.of());
        EventState eventState1 = new EventState(eventState);
        assertEquals(eventState1, eventState);
        assertNotSame(eventState1, eventState);
    }
    ...
    void getAllEventsTest() {
        ...
        assertEquals(eventState.getAllEvents(), eventList);
    }
    ...
    void findEventByNumberTest() {
        ...
        assertEquals(eventState.findEventByNumber(Integer.toUnsignedLong(1)), event0);
        assertEquals(eventState.findEventByNumber(Integer.toUnsignedLong(2)), event1);
        assertEquals(eventState.findEventByNumber(Integer.toUnsignedLong(3)), event2);
        assertNull(eventState.findEventByNumber(Integer.toUnsignedLong(5)));
    ...
    void createNonTicketedEventTest() {
        ...
        assertEquals(event0, eventtest0);
        assertEquals(event3, eventtest3);
    }
    ...
    void createTicketedEventTest() {
        ...
        assertEquals(event1, eventtest1);
        assertEquals(event2, eventtest2);
    ...
    void createEventPerformanceTest() {
        ...
        assertEquals(eventperformance1, eventperformancetest1);
        assertEquals(eventperformance2, eventperformancetest2);
